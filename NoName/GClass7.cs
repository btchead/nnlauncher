...
public class GClass7
{
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_AUTH);
	...
	{
		return new GClass11(ClientServerMessageFlags.CMSG_KEY);
	}
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_REQUEST_OFFSETS);
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_REQUEST_TOOL_OFFSETS);
		gclass.method_7((ushort)string_0.Length);
		gclass.method_14(string_0, string_0.Length);
		return gclass;
	}
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_REQEUEST_APAYLOAD);
		gclass.method_7((ushort)string_0.Length);
		gclass.method_14(string_0, string_0.Length);
		gclass.method_9(ulong_0);
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_UPLOAD_GAMEMODULE);
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_REQUEST_SCRIPTS);
		ushort num = (ushort)string_0.Length;
		gclass.method_7(num);
		gclass.method_14(string_0, (int)num);
		return gclass;
	...
	{
		GClass11 gclass = new GClass11(ClientServerMessageFlags.CMSG_DOWNLOAD_SCRIPT_REQUEST);
