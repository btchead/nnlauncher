...
public class MemoryHandlerCommunicator
{
    ...
    private long[] method_1()
    {
        ...
        KernelAPI.VirtualQueryEx(gclass14_0.processHandle, gclass14_0.process.MainModule.BaseAddress, out gstruct, Marshal.SizeOf(typeof(MemoryBasicInformation)));
        byte[] array = gclass14_0.method_4((long)gstruct.BaseAddress, (int)gstruct.RegionSize);
        if (array != null)
        {
            for (int i = (int)((long)(gclass14_0.process.MainModule.ModuleMemorySize / 4) & 4294963200L); i < (int)gstruct.RegionSize; i += 4096)
            {
    ...
    {
        if (long_0 <= (long)gclass14_0.process.MainModule.BaseAddress || long_0 >= (long)gclass14_0.process.MainModule.BaseAddress + (long)gclass14_0.process.MainModule.ModuleMemorySize)
        {
            MemoryBasicInformation gstruct;
            KernelAPI.VirtualQueryEx(gclass14_0.processHandle, (IntPtr)long_0, out gstruct, Marshal.SizeOf(typeof(MemoryBasicInformation)));
    ...
    private sealed class Class9
    {
        ...
        {
            gclass4_0.gclass14_0.WriteBytesToMemory((IntPtr)long_0, byte_0);
            gclass4_0.gclass14_0.method_0(true);
            gclass4_0.gclass14_0.method_3((IntPtr)(long_0 + (long)int_0));
            Thread.Sleep(25);
            gclass4_0.gclass14_0.method_0(false);
        }
