...
public class ProcessMemoryHandler
{
    ...
    {
        process = process_1;
        processHandle = OpenProcess(65535);
        Int64_0 = null;
    }
    ...
    public void method_0(bool bool_0)
    {
        ...
        WriteBytesToMemory(intPtr, array);
    }
    ...
    {
        IntPtr intPtr;
        return KernelAPI.CreateRemoteThread(processHandle, IntPtr.Zero, 0U, intptr_2, IntPtr.Zero, 0, out intPtr);
    }
    ...
    public byte[] method_4(long long_1, int int_0)
    {
        ...
        KernelAPI.ReadProcessMemory(processHandle, (IntPtr)long_1, array, array.Length, out zero);
    ...
    {
        return method_4((long)intptr_2, int_0);
    }

    public long method_6(IntPtr intptr_2)
    {
        return BitConverter.ToInt64(method_4((long)intptr_2, 8), 0);
    }

    public float method_7(IntPtr intptr_2)
    {
        return BitConverter.ToSingle(method_4((long)intptr_2, 4), 0);
    }

    public void method_8(IntPtr intptr_2, ref byte[] byte_0)
    {
        byte_0 = method_4((long)intptr_2, byte_0.Length);
    }

    public string method_9(IntPtr intptr_2, int int_0 = 32)
    {
        byte[] array = method_4((long)intptr_2, int_0);
        if (array == null)
        {
            return "Err";
        }
